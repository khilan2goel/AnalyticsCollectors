...
namespace AnalyticsCollector
{
    public class AzDevopsReleaseTimelineRecord : AzureDataExplorerService
    {
        ...
        public AzDevopsReleaseTimelineRecord(ReleaseRestAPIProvider releaseRestApiProvider, string serviceNameAndRegion, string aadTenantIdOrTenantName, string organizationName, string projectId)
