...
namespace AnalyticsCollector
{
    public class AzDevopsRelease : AzureDataExplorerService
    {
        ...
        public AzDevopsRelease(ReleaseRestAPIProvider releaseRestApiProvider, IKustoClientFactory kustoClientFactory, string kustoConnectionString, string aadTenantIdOrTenantName, string organizationName, string projectId)
