...
namespace AzureDataExplorer
{
    public class AzDevopsRelease : AzureDataExplorerService
    {
        ...
        public AzDevopsRelease(ReleaseRestAPIProvider releaseRestApiProvider, string serviceNameAndRegion, string authority, string organizationName, string projectId)
